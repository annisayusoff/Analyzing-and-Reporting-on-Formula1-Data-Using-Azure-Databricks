...
#rename columns & add ingestion date column
...
results_ingestion_date_df = add_ingestion_date(results_with_columns_df)

#drop unwanted column
results_final_df = results_ingestion_date_df.drop(col("statusId"))
